	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag (GraphVertexOutput IN ) : SV_Target
		    {
				...
				float temp_output_23_0 = (0.6 + (simplePerlin2D14 - 0.0) * (0.7 - 0.6) / (1.0 - 0.0));
				float blendOpSrc17 = IN.ase_color.g;
				float blendOpDest17 = temp_output_23_0;
				float temp_output_17_0 = ( saturate(  round( 0.5 * ( blendOpSrc17 + blendOpDest17 ) ) ));
				...
				float temp_output_30_0 = ( saturate(  round( 0.5 * ( blendOpSrc30 + blendOpDest30 ) ) ));
				...
				float3 Specular = lerpResult41.rgb;
				float Metallic = 0.0;
...
/*ASEBEGIN
Version=15305
1976;29;1857;1164;1632.285;1039.438;1.961784;True;True
...
Node;AmplifyShaderEditor.TFHCRemapNode;23;-609.2746,46.91587;Float;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0.6;False;4;FLOAT;0.7;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.BlendOpsNode;17;-228.9884,19.66062;Float;False;HardMix;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;5;-122.0124,-662.9463;Float;True;Property;_color2;color2;2;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.BlendOpsNode;30;-171.0998,-155.3668;Float;False;HardMix;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;11;243.3368,-392.273;Float;True;Property;_color3;color3;4;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;29;623.2506,-434.951;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;44;879.453,-25.3616;Float;False;Constant;_Float0;Float 0;7;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;1182.405,-67.29227;Float;False;True;2;Float;ASEMaterialInspector;0;1;terrainshader;1976390536c6c564abb90fe41f6ee334;0;0;Base;10;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=LightweightPipeline;RenderType=Opaque;Queue=Geometry;True;2;0;0;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;True;0;False;-1;True;True;True;True;True;0;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=LightweightForward;False;0;0;0;10;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;9;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=7AA88D882AA1CCA7AE86932437B50332D1D6D311